...
class PredictionsControllerTest < ActionController::TestCase
  ...
  test "should create prediction" do
    assert_difference('Prediction.count') do
      post :create, prediction: { rating1: @prediction.rating1, rating2: @prediction.rating2, volatility1: @prediction.volatility1, volatility2: @prediction.volatility2 }
    end
  ...
  test "should update prediction" do
    patch :update, id: @prediction, prediction: { rating1: @prediction.rating1, rating2: @prediction.rating2, volatility1: @prediction.volatility1, volatility2: @prediction.volatility2 }
    assert_redirected_to prediction_path(assigns(:prediction))
  end
